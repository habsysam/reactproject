                        ...
                        <form onSubmit={validate}>
                            <div className="card-body bg-white">
                                ...
                                <div className="row mt-3">
                                    ...
                                    <div className="col-md-6">
                                        <input  style={{position:"relative",left:"91px"}} className="form-check-input" type="checkbox" name="term" onChange={(event) => { updateUserDetailsWithTerms(event) }} />
                                        <span style={{position:"relative",left:"92px"}} > Terms and condition</span><br/>
